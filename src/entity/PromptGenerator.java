...
public class PromptGenerator {
    ...
    public String generatePlayerKilledPrompt(String playerKilled) {
        ...
        String instruction = ". Describe in detail how they were killed. Reveal the victim's name only at the end of " +
                "the story. Hidden in the story, include a extremely subtle and ambiguous hint of who the murderer " +
    ...
    public String generatePlayerVotedOutPrompt(String playerVotedOut, boolean isWerewolf) {
        ...
        String prompt = conversationHistory.getConversationHistory() + preamble + playerVotedOut + instruction + identity;
        conversationHistory.addUserMessage(prompt);
        return prompt;
    }
}
